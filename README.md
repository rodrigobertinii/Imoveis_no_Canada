...
Realizar uma análise exploratória de dados (EDA) e modelagem preditiva dos preços das casas em várias cidades canadenses. Além disso, construção de um Dashboard para visualização dos dados.
